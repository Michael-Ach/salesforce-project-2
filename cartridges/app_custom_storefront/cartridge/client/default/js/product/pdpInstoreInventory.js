...
function getModalHtmlElement() {
    ...
    var htmlString = '<!-- Modal -->'
        ...
        + "<button type='submit' class='btn btn-primary btn-block btn-lg detect-location' data-action='/on/demandware.store/Sites-siteID-Site/default/Stores-FindStores?showMap=true'>"
